...
# --------- CHEMINS A ADAPTER ----------
GEM5="/home/edilb/gem5/build/RISCV/gem5.opt" # chemin vers le binaire de gem5
CFG="/mnt/c/Users/edilb/Documents/Informatique/Architecture/ES201-TP/TP4/ex4" # chemin vers le script de configuration de la simulation

BIN_DIR="/mnt/c/Users/edilb/Documents/Informatique/Architecture/ES201-TP/TP4/Projet/"   # là où sont les .riscv
# ------------------------------------------
...
for size_cache in "1kB" "2kB" "4kB" "8kB" "16kB"; do # on teste différentes tailles de cache L1
    ...
    OUT_DIR="m5out_A7/size_${size_cache}" # répertoire de sortie spécifique pour cette configuration de cache
...
for size_cache in "2kB" "4kB" "8kB" "16kB" "32kB"; do
    ...
    OUT_DIR="m5out_A15/size_${size_cache}"
    mkdir -p "$OUT_DIR"
